...
function Carousel(props) {
    ...
    return (
        <section className="overflow-hidden relative">
            ...
            <div id="layer" className="bg-gradient-to-b from-[rgba(0,0,0,0)] to-stone-950 absolute top-0 left-0 w-full h-full"></div>
            ...
            <div className="
                ...
                mx-auto w-64">
                <svg id="logo" className="translate-y-0 opacity-100 lg:translate-y-[20%] lg:opacity-0 fill-white w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 514 138" version="1.1">
                ...
                <p id="line" className="translate-y-0 opacity-100 lg:translate-y-[20%] lg:opacity-0 sm:block hidden text-stone-300 font-light text-center mt-4 italic tracking-widest">Capture the perfect one!</p>
            </div>
