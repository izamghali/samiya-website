...
function Carousel(props) {
    ...
    return (
        <section className="overflow-hidden relative">
            ...
            <div className="absolute bottom-40 right-0 left-0 mx-auto w-64 border-violet-400">
                ...
                <p className="text-stone-400 text-center mt-4 italic tracking-widest">Capture the perfect one!</p>
            </div>
