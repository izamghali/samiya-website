    ...
    return (
        <section className="cont bg-black">
            ...
            <div className="card-container">
                ...
                {/* card */}
                {teamData.map(data => {
                    return <div className="relative group md:max-w-[26rem] sm:w-[20rem] w-full overflow-hidden">
                            ...
                            ">
                                <h3 className="border-2 border-black text-white text-xl">{data.name}</h3>
                                <p className="text-darkGray">{data.pro}</p>

                                <a target="_blank" href={data.link} className="mt-4 flex gap-1 items-center text-accent hover:underline">
                                    <svg class="bi bi-instagram fill-accent w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
